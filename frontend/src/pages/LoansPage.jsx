...
function fmtDate(str) {
  if (!str) return '—'
  return new Date(str).toLocaleDateString('en-SG', { day: '2-digit', month: 'short', year: 'numeric', timeZone: 'Asia/Singapore' })
}
                  ...
                  >
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-sm font-['Lato']">
                        ...
                        <span className="font-semibold text-ink">{fmt(loan.amount)}</span>
                      </div>
                      <div className="flex justify-between text-sm font-['Lato']">
